...
<template>
    <div class="mx-6 mt-16 rounded-2xl overflow-hidden bg-white shadow-2xl xs:max-w-md xs:mx-auto">
        ...
        <div class="p-6 pb-4">
            ...
            <div class="flex flex-row items-center mt-6 p-4 rounded-xl bg-very-pale-blue">
                ...
                <a href="#" class="text-xs font-bold text-indigo-700 underline">Change</a>
            </div>
            <button class="w-full mt-6 py-3 shadow-2xl rounded-xl bg-indigo-700 font-bold text-gray-200">Proceed to Payment</button>
            <button class="w-full mt-2 py-3 rounded-xl font-bold">Cancel Order</button>
        </div>
    </div>
